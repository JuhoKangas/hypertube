  ...
  return (
    <div className='flex flex-col h-screen bg-cover bg-landing-bg'>
      ...
      <div className='flex flex-row justify-center md:gap-36 gap-3 mt-40'>
        <div>
          <button
            className='w-32 h-12 bg-dark-red font-bold text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline border border-hyper-black md:border-none'
