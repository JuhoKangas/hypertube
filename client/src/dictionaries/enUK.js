export const enUK = {
  ...
  mov_choose_genre: 'Choose a genre',
  mov_min_rating: 'Minimum rating',
  mov_choose_value: 'Choose a value',
  mov_sort_by: 'Sort by',
  mov_like_count: 'Like count',
  mov_title: 'Title',
  mov_year: 'Year',
  mov_rating: 'Rating',
  mov_order_by: 'Order by',
  mov_order_desc: 'Descending',
  mov_order_asc: 'Ascending',
  mov_search: 'Search',
  mov_not_found: 'No movies found!',
  mov_button: 'Watch the movie',
